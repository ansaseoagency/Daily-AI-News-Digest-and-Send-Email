...
The automation is implemented using **n8n** with a modular, scalable architecture. Each stage of the workflow is clearly separated to improve readability, debugging, and future extensibility.
